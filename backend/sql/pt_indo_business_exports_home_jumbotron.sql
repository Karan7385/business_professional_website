...
CREATE TABLE `home_jumbotron` (
  ...
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'PT ATLAS GLOBAL VENTURES',
  ...
  `body` varchar(2000) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'From farm-level selection to export-ready processing, PT ATLAS GLOBAL VENTURES delivers authentic taste, aroma, and purity to spice traders, food manufacturers, and distributors worldwide.',
