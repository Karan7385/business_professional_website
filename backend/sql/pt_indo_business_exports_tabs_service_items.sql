...
--
-- Table structure for table `tabs_service_items`
--

DROP TABLE IF EXISTS `tabs_service_items`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tabs_service_items` (
...
--
-- Dumping data for table `tabs_service_items`
--
...
-- Dump completed on 2026-01-21  1:35:05
